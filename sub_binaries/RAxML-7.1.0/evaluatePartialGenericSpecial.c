...
#ifdef WIN32
static void computeVectorGTRCATSECONDARY(double *lVector, int *eVector, double ki, int i, double qz, double rz,
					 traversalInfo *ti, double *EIGN, double *EI, double *EV, double *tipVector, 
					 unsigned char **yVector, int mxtips)
#else
...
#ifdef WIN32
static void computeVectorGTRCATSECONDARY_6(double *lVector, int *eVector, double ki, int i, double qz, double rz,
					   traversalInfo *ti, double *EIGN, double *EI, double *EV, double *tipVector, 
					   unsigned char **yVector, int mxtips)
#else
...
#ifdef WIN32
static void computeVectorGTRCATSECONDARY_7(double *lVector, int *eVector, double ki, int i, double qz, double rz,
					   traversalInfo *ti, double *EIGN, double *EI, double *EV, double *tipVector, 
					   unsigned char **yVector, int mxtips)
#else
...
#ifdef WIN32
static void computeVectorGTRCAT_BINARY(double *lVector, int *eVector, double ki, int i, double qz, double rz,
				       traversalInfo *ti, double *EIGN, double *EI, double *EV, double *tipVector, 
				       unsigned char **yVector, int mxtips)
#else
					   ...
					   int branchReference, int mxtips)
{
  ...
  for(k = 1; k < counter; k++)                
    computeVectorGTRCAT_BINARY(lVector, eVector, ki, i, ti[k].qz[branchReference], ti[k].rz[branchReference], &ti[k], 
			       EIGN, EI, EV, 
					     ...
					     int branchReference, int mxtips)
{
  ...
  for(k = 1; k < counter; k++)                
    computeVectorGTRCATSECONDARY(lVector, eVector, ki, i, ti[k].qz[branchReference], ti[k].rz[branchReference], 
				 &ti[k], EIGN, EI, EV, 
				 tipVector, yVector, mxtips);       
					       ...
					       int branchReference, int mxtips)
{
  ...
  for(k = 1; k < counter; k++)                
    computeVectorGTRCATSECONDARY_6(lVector, eVector, ki, i, ti[k].qz[branchReference], ti[k].rz[branchReference], 
				   &ti[k], EIGN, EI, EV, 
				   tipVector, yVector, mxtips);       
					       ...
					       int branchReference, int mxtips)
{
  ...
  for(k = 1; k < counter; k++)                
    computeVectorGTRCATSECONDARY_7(lVector, eVector, ki, i, ti[k].qz[branchReference], ti[k].rz[branchReference], 
				   &ti[k], EIGN, EI, EV, 
				   tipVector, yVector, mxtips);       
