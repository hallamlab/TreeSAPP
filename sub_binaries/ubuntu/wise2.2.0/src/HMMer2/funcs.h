...
/* funcs.h 
 * RCS $Id: funcs.h,v 1.1.1.1 2010/03/18 22:55:58 soo Exp $
 *
...
extern HMMFILE *HMMFileOpenFseek(char *hmmfile, char *env,int pos);
...
extern long     HMMFtell(HMMFILE * hmmfp);
extern int      HMMFseek(HMMFILE * hmmfp,long pos);
