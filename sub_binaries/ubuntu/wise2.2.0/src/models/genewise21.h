 ...
 *
 */
GeneWise21 * Wise2_allocate_Expl_GeneWise21(GeneWiseScore* query,ComplexSequence* target ,GeneParser21Score * gp21,RandomCodonScore * rndcodon,RandomModelDNAScore * rndbase);
...
boolean Wise2_dc_start_end_calculate_GeneWise21(GeneWise21 * mat,DPEnvelope * dpenv);
#define dc_start_end_calculate_GeneWise21 Wise2_dc_start_end_calculate_GeneWise21
...
int Wise2_find_end_GeneWise21(GeneWise21 * mat,int * ri,int * rj,int * state,boolean * isspecial);
...
int Wise2_max_calc_GeneWise21(GeneWise21 * mat,int i,int j,int state,boolean isspecial,int * reti,int * retj,int * retstate,boolean * retspecial,int * cellscore);
#define max_calc_GeneWise21 Wise2_max_calc_GeneWise21
int Wise2_max_calc_special_GeneWise21(GeneWise21 * mat,int i,int j,int state,boolean isspecial,int * reti,int * retj,int * retstate,boolean * retspecial,int * cellscore);
