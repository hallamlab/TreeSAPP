 ...
 *
 */
EstFrag3 * Wise2_allocate_Expl_EstFrag3(GeneWiseScore* query,ComplexSequence* target ,cDNAParserScore * cp,Score start_frag,Score end_frag);
...
boolean Wise2_dc_start_end_calculate_EstFrag3(EstFrag3 * mat,DPEnvelope * dpenv);
#define dc_start_end_calculate_EstFrag3 Wise2_dc_start_end_calculate_EstFrag3
...
int Wise2_find_end_EstFrag3(EstFrag3 * mat,int * ri,int * rj,int * state,boolean * isspecial);
...
int Wise2_max_calc_EstFrag3(EstFrag3 * mat,int i,int j,int state,boolean isspecial,int * reti,int * retj,int * retstate,boolean * retspecial,int * cellscore);
#define max_calc_EstFrag3 Wise2_max_calc_EstFrag3
int Wise2_max_calc_special_EstFrag3(EstFrag3 * mat,int i,int j,int state,boolean isspecial,int * reti,int * retj,int * retstate,boolean * retspecial,int * cellscore);
