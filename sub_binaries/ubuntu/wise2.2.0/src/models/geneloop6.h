 ...
 *
 */
Search_Return_Type Wise2_search_GeneLoop6(DBSearchImpl * dbsi,Hscore * out,GeneWiseScore * query,GenomicDB* targetdb ,GeneParser4Score * gp);
 ...
 *
 */
Search_Return_Type Wise2_serial_search_GeneLoop6(Hscore * out,GeneWiseScore * query,GenomicDB* targetdb ,GeneParser4Score * gp);
 ...
 *
 */
GeneLoop6 * Wise2_allocate_Expl_GeneLoop6(GeneWiseScore * query,ComplexSequence* target ,GeneParser4Score * gp);
...
boolean Wise2_dc_start_end_calculate_GeneLoop6(GeneLoop6 * mat,DPEnvelope * dpenv);
#define dc_start_end_calculate_GeneLoop6 Wise2_dc_start_end_calculate_GeneLoop6
...
int Wise2_find_end_GeneLoop6(GeneLoop6 * mat,int * ri,int * rj,int * state,boolean * isspecial);
...
int Wise2_max_calc_GeneLoop6(GeneLoop6 * mat,int i,int j,int state,boolean isspecial,int * reti,int * retj,int * retstate,boolean * retspecial,int * cellscore);
#define max_calc_GeneLoop6 Wise2_max_calc_GeneLoop6
int Wise2_max_calc_special_GeneLoop6(GeneLoop6 * mat,int i,int j,int state,boolean isspecial,int * reti,int * retj,int * retstate,boolean * retspecial,int * cellscore);
