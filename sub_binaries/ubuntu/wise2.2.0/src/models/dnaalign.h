 ...
 *
 */
DnaAlign * Wise2_allocate_Expl_DnaAlign(ComplexSequence* query,ComplexSequence* target ,DnaMatrix* comp,Score qgap,Score qext,Score tgap,Score text,DnaStartEnd * startend);
...
boolean Wise2_dc_start_end_calculate_DnaAlign(DnaAlign * mat,DPEnvelope * dpenv);
#define dc_start_end_calculate_DnaAlign Wise2_dc_start_end_calculate_DnaAlign
...
int Wise2_find_end_DnaAlign(DnaAlign * mat,int * ri,int * rj,int * state,boolean * isspecial);
...
int Wise2_max_calc_DnaAlign(DnaAlign * mat,int i,int j,int state,boolean isspecial,int * reti,int * retj,int * retstate,boolean * retspecial,int * cellscore);
#define max_calc_DnaAlign Wise2_max_calc_DnaAlign
int Wise2_max_calc_special_DnaAlign(DnaAlign * mat,int i,int j,int state,boolean isspecial,int * reti,int * retj,int * retstate,boolean * retspecial,int * cellscore);
