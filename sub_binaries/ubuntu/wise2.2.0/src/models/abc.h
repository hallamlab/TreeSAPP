...
/* Function:  allocate_Expl_abc(query,target,comp,a,b,c)
 *
 ...
 *
 */
abc * Wise2_allocate_Expl_abc(ComplexSequence* query,ComplexSequence* target ,CompMat* comp,int a,int b,int c);
...
boolean Wise2_dc_start_end_calculate_abc(abc * mat,DPEnvelope * dpenv);
#define dc_start_end_calculate_abc Wise2_dc_start_end_calculate_abc
...
int Wise2_find_end_abc(abc * mat,int * ri,int * rj,int * state,boolean * isspecial);
...
int Wise2_max_calc_abc(abc * mat,int i,int j,int state,boolean isspecial,int * reti,int * retj,int * retstate,boolean * retspecial,int * cellscore);
#define max_calc_abc Wise2_max_calc_abc
int Wise2_max_calc_special_abc(abc * mat,int i,int j,int state,boolean isspecial,int * reti,int * retj,int * retstate,boolean * retspecial,int * cellscore);
