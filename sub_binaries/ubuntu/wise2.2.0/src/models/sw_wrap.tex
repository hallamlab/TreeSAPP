...
\begin{description}
\item[External C] {\tt Wise2_Align_Proteins_SmithWaterman (one,two,comp,gap,ext,dpri)}
\item[Perl] {\tt &Wise2::Align_Proteins_SmithWaterman (one,two,comp,gap,ext,dpri)}
...
\begin{description}
\item[External C] {\tt Wise2_Align_Proteins_ABC (one,two,comp,a,b,c,dpri)}
\item[Perl] {\tt &Wise2::Align_Proteins_ABC (one,two,comp,a,b,c,dpri)}
...
\begin{description}
\item[External C] {\tt Wise2_Align_Sequences_ProteinABC (one,two,comp,a,b,c,dpri)}
\item[Perl] {\tt &Wise2::Align_Sequences_ProteinABC (one,two,comp,a,b,c,dpri)}
