...
Wise2_AlnBlock *
Align_strings_ProteinSmithWaterman(one,two,comp,gap,ext,dpri)
	char * one
	char * two
	Wise2_CompMat * comp
	int gap
	...
	CODE:
	RETVAL = Wise2_Align_strings_ProteinSmithWaterman(one,two,comp,gap,ext,dpri);
	OUTPUT:
	RETVAL
...
Wise2_AlnBlock *
Align_Sequences_ProteinSmithWaterman(one,two,comp,gap,ext,dpri)
	Wise2_Sequence * one
	Wise2_Sequence * two
	Wise2_CompMat * comp
	int gap
	...
	Wise2_DPRunImpl * dpri
	CODE:
	RETVAL = Wise2_Align_Sequences_ProteinSmithWaterman(one,two,comp,gap,ext,dpri);
	OUTPUT:
	RETVAL
...
Wise2_AlnBlock *
Align_Proteins_SmithWaterman(one,two,comp,gap,ext,dpri)
	Wise2_Protein * one
	Wise2_Protein * two
	Wise2_CompMat * comp
	int gap
	...
	Wise2_DPRunImpl * dpri
	CODE:
	RETVAL = Wise2_Align_Proteins_SmithWaterman(one,two,comp,gap,ext,dpri);
	OUTPUT:
	RETVAL
...
Wise2_AlnBlock *
Align_Proteins_ABC(one,two,comp,a,b,c,dpri)
	Wise2_Protein * one
	Wise2_Protein * two
	Wise2_CompMat * comp
	int a
	...
	Wise2_DPRunImpl * dpri
	CODE:
	RETVAL = Wise2_Align_Proteins_ABC(one,two,comp,a,b,c,dpri);
	OUTPUT:
	RETVAL
...
Wise2_AlnBlock *
Align_Sequences_ProteinABC(one,two,comp,a,b,c,dpri)
	Wise2_Sequence * one
	Wise2_Sequence * two
	Wise2_CompMat * comp
	int a
	...
	Wise2_DPRunImpl * dpri
	CODE:
	RETVAL = Wise2_Align_Sequences_ProteinABC(one,two,comp,a,b,c,dpri);
	OUTPUT:
	RETVAL
