 ...
 *
 */
Search_Return_Type Wise2_search_EstLoop3(DBSearchImpl * dbsi,Hscore * out,GeneWiseScore * query,cDNADB* targetdb ,cDNAParserScore * cp);
 ...
 *
 */
Search_Return_Type Wise2_serial_search_EstLoop3(Hscore * out,GeneWiseScore * query,cDNADB* targetdb ,cDNAParserScore * cp);
 ...
 *
 */
EstLoop3 * Wise2_allocate_Expl_EstLoop3(GeneWiseScore * query,ComplexSequence* target ,cDNAParserScore * cp);
...
boolean Wise2_dc_start_end_calculate_EstLoop3(EstLoop3 * mat,DPEnvelope * dpenv);
#define dc_start_end_calculate_EstLoop3 Wise2_dc_start_end_calculate_EstLoop3
...
int Wise2_find_end_EstLoop3(EstLoop3 * mat,int * ri,int * rj,int * state,boolean * isspecial);
...
int Wise2_max_calc_EstLoop3(EstLoop3 * mat,int i,int j,int state,boolean isspecial,int * reti,int * retj,int * retstate,boolean * retspecial,int * cellscore);
#define max_calc_EstLoop3 Wise2_max_calc_EstLoop3
int Wise2_max_calc_special_EstLoop3(EstLoop3 * mat,int i,int j,int state,boolean isspecial,int * reti,int * retj,int * retstate,boolean * retspecial,int * cellscore);
