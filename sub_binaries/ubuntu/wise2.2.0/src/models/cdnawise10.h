 ...
 *
 */
CdnaWise10 * Wise2_allocate_Expl_CdnaWise10(ComplexSequence* query,ComplexSequence* target ,GeneParser4Score * gp,CodonMatrixScore * sc,RandomCodonScore * rndcodon,DnaMatrix* utr,Score gap_open,Score gap_ext,Score utr_gap,Score intron_gap);
...
boolean Wise2_dc_start_end_calculate_CdnaWise10(CdnaWise10 * mat,DPEnvelope * dpenv);
#define dc_start_end_calculate_CdnaWise10 Wise2_dc_start_end_calculate_CdnaWise10
...
int Wise2_find_end_CdnaWise10(CdnaWise10 * mat,int * ri,int * rj,int * state,boolean * isspecial);
...
int Wise2_max_calc_CdnaWise10(CdnaWise10 * mat,int i,int j,int state,boolean isspecial,int * reti,int * retj,int * retstate,boolean * retspecial,int * cellscore);
#define max_calc_CdnaWise10 Wise2_max_calc_CdnaWise10
int Wise2_max_calc_special_CdnaWise10(CdnaWise10 * mat,int i,int j,int state,boolean isspecial,int * reti,int * retj,int * retstate,boolean * retspecial,int * cellscore);
