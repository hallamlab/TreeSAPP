 ...
 *
 */
GeneWise6 * Wise2_allocate_Expl_GeneWise6(GeneWiseScore* query,ComplexSequence* target ,GeneParser4Score * gp);
...
boolean Wise2_dc_start_end_calculate_GeneWise6(GeneWise6 * mat,DPEnvelope * dpenv);
#define dc_start_end_calculate_GeneWise6 Wise2_dc_start_end_calculate_GeneWise6
...
int Wise2_find_end_GeneWise6(GeneWise6 * mat,int * ri,int * rj,int * state,boolean * isspecial);
...
int Wise2_max_calc_GeneWise6(GeneWise6 * mat,int i,int j,int state,boolean isspecial,int * reti,int * retj,int * retstate,boolean * retspecial,int * cellscore);
#define max_calc_GeneWise6 Wise2_max_calc_GeneWise6
int Wise2_max_calc_special_GeneWise6(GeneWise6 * mat,int i,int j,int state,boolean isspecial,int * reti,int * retj,int * retstate,boolean * retspecial,int * cellscore);
