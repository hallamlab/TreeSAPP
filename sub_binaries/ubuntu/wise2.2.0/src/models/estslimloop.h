 ...
 *
 */
EstSlimLoop3 * Wise2_allocate_Expl_EstSlimLoop3(GeneWiseScore* query,ComplexSequence* target ,cDNAParserScore * cp);
...
boolean Wise2_dc_start_end_calculate_EstSlimLoop3(EstSlimLoop3 * mat,DPEnvelope * dpenv);
#define dc_start_end_calculate_EstSlimLoop3 Wise2_dc_start_end_calculate_EstSlimLoop3
...
int Wise2_find_end_EstSlimLoop3(EstSlimLoop3 * mat,int * ri,int * rj,int * state,boolean * isspecial);
...
int Wise2_max_calc_EstSlimLoop3(EstSlimLoop3 * mat,int i,int j,int state,boolean isspecial,int * reti,int * retj,int * retstate,boolean * retspecial,int * cellscore);
#define max_calc_EstSlimLoop3 Wise2_max_calc_EstSlimLoop3
int Wise2_max_calc_special_EstSlimLoop3(EstSlimLoop3 * mat,int i,int j,int state,boolean isspecial,int * reti,int * retj,int * retstate,boolean * retspecial,int * cellscore);
