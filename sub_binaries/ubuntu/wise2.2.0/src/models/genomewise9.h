 ...
 *
 */
GenomeWise9 * Wise2_allocate_Expl_GenomeWise9(GenomeEvidenceSet* evi,ComplexSequence* gen ,int switchcost,int newgenecost,int non_start_codon,int non_stop_codon,RandomCodonScore * rndcodon);
...
boolean Wise2_dc_start_end_calculate_GenomeWise9(GenomeWise9 * mat,DPEnvelope * dpenv);
#define dc_start_end_calculate_GenomeWise9 Wise2_dc_start_end_calculate_GenomeWise9
...
int Wise2_find_end_GenomeWise9(GenomeWise9 * mat,int * ri,int * rj,int * state,boolean * isspecial);
...
int Wise2_max_calc_GenomeWise9(GenomeWise9 * mat,int i,int j,int state,boolean isspecial,int * reti,int * retj,int * retstate,boolean * retspecial,int * cellscore);
#define max_calc_GenomeWise9 Wise2_max_calc_GenomeWise9
int Wise2_max_calc_special_GenomeWise9(GenomeWise9 * mat,int i,int j,int state,boolean isspecial,int * reti,int * retj,int * retstate,boolean * retspecial,int * cellscore);
