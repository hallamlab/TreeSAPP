 ...
 *
 */
GeneLiteModel * Wise2_allocate_Expl_GeneLiteModel(GwLiteScore* query,ComplexSequence* target ,GeneParser4Score * gp);
...
boolean Wise2_dc_start_end_calculate_GeneLiteModel(GeneLiteModel * mat,DPEnvelope * dpenv);
#define dc_start_end_calculate_GeneLiteModel Wise2_dc_start_end_calculate_GeneLiteModel
...
int Wise2_find_end_GeneLiteModel(GeneLiteModel * mat,int * ri,int * rj,int * state,boolean * isspecial);
...
int Wise2_max_calc_GeneLiteModel(GeneLiteModel * mat,int i,int j,int state,boolean isspecial,int * reti,int * retj,int * retstate,boolean * retspecial,int * cellscore);
#define max_calc_GeneLiteModel Wise2_max_calc_GeneLiteModel
int Wise2_max_calc_special_GeneLiteModel(GeneLiteModel * mat,int i,int j,int state,boolean isspecial,int * reti,int * retj,int * retstate,boolean * retspecial,int * cellscore);
