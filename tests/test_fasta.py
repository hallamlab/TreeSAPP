...
class MyTestCase(unittest.TestCase):
    ...
    def tearDown(self) -> None:
        ...
        test_fa_prefix, ext = os.path.splitext(os.path.basename(self.test_fa))
        test_fq_prefix, ext = os.path.splitext(os.path.basename(self.test_fq))
    ...
    def test_sequence_info_groups(self):
        ...
        header_format_re, header_db, header_molecule = get_header_format(seq_name, self.header_regexes)
