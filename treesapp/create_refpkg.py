...
def clean_up_raxmlng_all_outputs(phylogeny_dir: str, final_output_dir: str,
                                 ref_pkg: classy.ReferencePackage, fasta_replace_dict: dict) -> None:
    output_prefix = phylogeny_dir + ref_pkg.prefix
    try:
        raw_newick_tree = glob.glob(output_prefix + ".*.bestTree")[0]
    except IndexError:
    ...
    utilities.swap_tree_names(raw_newick_tree, ref_pkg.tree, ref_pkg.prefix)
    utilities.swap_tree_names(bootstrap_tree, bootstrap_nameswap, ref_pkg.prefix)
